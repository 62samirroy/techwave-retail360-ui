    ...
    <div className="space-y-5">
      ...
      <div className="bg-white p-4 rounded-2xl border border-stone-200/80 shadow-xs flex flex-wrap items-center gap-3">
        ...
        <span className="text-xs font-mono text-stone-500 ml-auto hidden md:block">
          <span className="font-semibold text-stone-900">{totalCustomers}</span> verified buyers registered
        </span>
      </div>
              ...
              <tbody className="divide-y divide-stone-100">
                {customers.map((customer) => (
                  <tr key={customer.id} className="hover:bg-purple-50/20 transition-colors">
                    ...
                    {/* Lifetime Value */}
                    <td className="py-3 px-4 font-mono font-bold text-purple-700 text-xs">
